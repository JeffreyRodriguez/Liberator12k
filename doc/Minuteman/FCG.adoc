...
NOTE: STL Files Location: `Receiver/FCG_{units}/Prints/`


// Only show the disconnector if the fcg-disconnector attribute is set
:fcg-disconnector-stl:
ifdef::fcg-disconnector[]
:fcg-disconnector-stl: image:../src/Receiver/.export/FCG_{units}/Prints/Disconnector.png[] Disconnector
endif::[]

.FCG Printed Parts
[cols="^1,^1,^1,^1"]
|===
|image:../src/Receiver/.export/FCG_{units}/Prints/Housing.png[] Housing
|image:../src/Receiver/.export/FCG_{units}/Prints/FiringPinCollar.png[] FiringPinCollar
|image:../src/Receiver/.export/FCG_{units}/Prints/ChargingHandle.png[] ChargingHandle
|{fcg-disconnector-stl}

|image:../src/Receiver/.export/FCG_{units}/Prints/Hammer.png[] Hammer
|image:../src/Receiver/.export/FCG_{units}/Prints/HammerTail.png[] HammerTail
|image:../src/Receiver/.export/FCG_{units}/Prints/TriggerMiddle.png[] TriggerMiddle
|image:../src/Receiver/.export/FCG_{units}/Prints/Trigger.png[] Trigger
|===
...
.Trigger X-Ray
image::../.views/Receiver/FCG_{units}/XRay_Trigger.png[]
