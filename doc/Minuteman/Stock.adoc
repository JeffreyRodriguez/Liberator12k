...
.Stock Assembly
images::../src/Receiver/.stl/Stock.png[]
...
[cols="^1,^1"]
|===
|image:../src/Receiver/.stl/Stock/Prints/Stock_Backplate.png[] Stock Backplate
|image:../src/Receiver/.stl/Stock/Prints/Stock_Buttpad.png[] Stock Buttpad
|===
...
==== Buttstock
Insert the _Stock Buttpad Bolts_ through the _Stock_Buttpad_, and screw
into the back of the _Stock_Backplate_.
