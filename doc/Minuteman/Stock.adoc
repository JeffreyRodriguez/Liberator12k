...
.Stock Assembly
image::../.views/Receiver/Stock_{units}/Assembly.png[]
...
<<<
==== Prints
NOTE: STL Files Location: `Receiver/Stock_{units}/Prints/`

.Stock Printed Parts
[cols="^1,^1"]
|===
|image:../src/Receiver/.export/Stock_{units}/Prints/Stock_Backplate.png[] Stock Backplate
|image:../src/Receiver/.export/Stock_{units}/Prints/Stock_Buttpad.png[] Stock Buttpad
|===
...
.Stock X-Ray
image::../.views/Receiver/Stock_{units}/XRay_Assembly.png[]
