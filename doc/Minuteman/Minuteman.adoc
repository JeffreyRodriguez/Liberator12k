...
|image:../.views/Preview_FCG.png[] Fire Control Group (FCG)
|image:../.views/Preview_Frame.png[] Large Frame Receiver

|image:../.views/Preview_Lower.png[] Lower Receiver
|image:../.views/Preview_Stock.png[] Stock
|===
