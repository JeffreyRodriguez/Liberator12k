...
NOTE: STL Files Location: `Receiver/Frame/Prints/`

[cols="^1"]
|===
|image:../src/Receiver/.export/Frame/Prints/Frame_Receiver.png[] Frame Receiver
|===

include::Frame_BOM_Inch.adoc[]

<<<
==== Post-Processing

.Frame Heatset Nuts
image::../.views/XRay_Frame.png[]
