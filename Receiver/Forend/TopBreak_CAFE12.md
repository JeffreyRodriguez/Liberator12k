...
barrel isn't a separate piece you need 3 hands to reload. Since it's built with
\#Liberator12k platform components it features:
...
|----------------------------------|--------|----------|------------|
| 1" NPT Schedule 40 Galv. Pipe    | HWS    | 2pcs     | $2         |
| 3/4" NPT Schedule 40 Galv. Pipe  | HWS    | 2pcs     | $2         |
