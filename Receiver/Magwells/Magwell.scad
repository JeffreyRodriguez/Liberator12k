...
module MagwellInsert(height=Inches(1.725), taperHeight=Inches(0.75)) {
  union() {
...
module Magwell(width=Inches(1), height=Inches(1.75),
               wall=Inches(0.25), wallFront=Inches(0.5), magOffsetX=0.90,
